...
| 15 | Canal empresas en v0.3 | Layout v0.2 + glosario + **Situación y semáforo (v0.3.1)**; ticket de dos campos y multiventana pendientes | parcial |
...
| 21 | Capa aiRoss en la primera demo | Maxi decidió meterla toda (21-sep). Interruptor global ☰ → Capa aiRoss para apagarla si conviene | ✅ decidido |
| 22 | Máximos y mínimos anuales del semáforo | Simulados: mid ±7 %. Con market data real (R-02) serían reales | default |
| 23 | Tope de margen y aviso fuera de mercado | 12 pips y 25 pips por defecto; configurables en ☰. Política real la fija la mesa | default |
